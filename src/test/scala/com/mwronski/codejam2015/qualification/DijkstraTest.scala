  ...
  describe("2015-C: Dijkstra") {
    ...
    describe("File tasks") {
      ...
      it("Should solve small tasks") {
        Given("small tasks")
        val in = Source.fromFile("src/test/resources/2015/qualification/C-small-practice.in").getLines()
        in.next() //skip number of test cases
        And("solutions for small tasks ")
        val out = Source.fromFile("src/test/resources/2015/qualification/C-small-practice.out").getLines()
      ...
      it("Should solve large tasks") {
        Given("large tasks")
        val in = Source.fromFile("src/test/resources/2015/qualification/C-large-practice.in").getLines()
        in.next() //skip number of test cases
        And("solutions for large tasks ")
        val out = Source.fromFile("src/test/resources/2015/qualification/C-large-practice.out").getLines()
